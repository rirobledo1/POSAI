// src/components/categories/CategoryManagerNew.tsx
'use client';
...
interface Category {
  ...
  description?: string;
  active: boolean;
  productCount?: number; // Cambiar a camelCase para coincidir con el API
  product_count?: number; // Mantener por compatibilidad
  created_at?: string;
  updated_at?: string;
}
...
export default function CategoryManagerNew() {
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[180px] max-w-[220px]">
                  Descripción
                </th>
