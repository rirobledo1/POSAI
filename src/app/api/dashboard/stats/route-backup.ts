...
export async function GET() {
  try {
    ...
    // UNA SOLA consulta SQL optimizada para obtener estadísticas principales
    ...
    console.log(`✅ Dashboard stats computed in ${response.performanceMs}ms (${response.queryCount} queries)`)
